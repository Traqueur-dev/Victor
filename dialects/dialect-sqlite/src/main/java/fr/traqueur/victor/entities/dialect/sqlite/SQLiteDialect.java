...
public class SQLiteDialect implements Dialect {
    ...
    public String buildConnectionUrl(String host, int port, String database, Properties properties) {
        ...
        if (database.equals(":memory:")) {
            // Use shared cache mode for in-memory databases to allow connection pooling
        ...
        // Append additional properties if any
    ...
    public String generateCreateTable(EntityMetadata metadata) {
        ...
        // Primary key - Only add if not already defined inline (i.e., not auto-generated)
    ...
    private String generateColumnDefinition(FieldMetadata field) {
        ...
        // For SQLite, AUTOINCREMENT must be combined with PRIMARY KEY inline
