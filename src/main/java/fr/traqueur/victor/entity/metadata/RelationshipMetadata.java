...
/**
 * Describes a relationship field on a E (OneToMany, ManyToOne, ManyToMany, OneToOne).
 */
public final class RelationshipMetadata {
    ...
    // For ONE_TO_MANY and ONE_TO_ONE (inverse side): field name in target E
    ...
    private RelationshipMetadata(Builder b) {
        ...
        this.targetEntityClass = b.targetEntityClass;
        this.type = b.type;
    ...
    public static RelationshipMetadata ofRecordComponent(RecordComponent component) {
        ...
        if (mto != null) {
            ...
            return new Builder(name, mto.targetEntity(), RelationType.MANY_TO_ONE)
    ...
    // -------------------------------------------------------------------------
    // Factory methods — from Field (class-based E)
    // -------------------------------------------------------------------------
    ...
    private static final class Builder {
        ...
        Builder(String fieldName, Class<?> targetEntityClass, RelationType type) {
