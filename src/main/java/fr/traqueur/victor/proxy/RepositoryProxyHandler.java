...
public class RepositoryProxyHandler<DTO extends Dto<MODEL>, MODEL extends Entity<ID>, ID>
    ...
    private DTO insert(DTO dto, MODEL model) {
        String sql = sqlGenerator.generateInsert(entityMetadata);
    ...
    private DTO update(DTO dto, MODEL model) {
        String sql = sqlGenerator.generateUpdate(entityMetadata);
    ...
    private void deleteById(ID id) {
        String sql = sqlGenerator.generateDelete(entityMetadata);
        Object[] params = { id };
    ...
    private boolean existsById(ID id) {
        String sql = sqlGenerator.generateExists(entityMetadata);
        Object[] params = { id };
    ...
    private long count() {
        String sql = sqlGenerator.generateCount(entityMetadata);
    ...
    private void deleteAll() {
        String sql = "DELETE FROM " + entityMetadata.getFullTableName();
    ...
    @SuppressWarnings("unchecked")
    public static <T> T createProxy(Class<T> repositoryInterface, SqlExecutor sqlExecutor, SqlGenerator sqlGenerator) {
        var handler = new RepositoryProxyHandler<>(repositoryInterface, sqlExecutor, sqlGenerator);
