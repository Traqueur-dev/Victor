...
import fr.traqueur.victor.repository.PassportRepository;
import fr.traqueur.victor.repository.PersonRepository;
import fr.traqueur.victor.repository.StudentRepository;
import fr.traqueur.victor.repository.TypesRepository;
...
public abstract class AbstractVictorTest {
    ...
    protected TypesRepository typesRepo;
    protected PersonRepository personRepo;
    protected PassportRepository passportRepo;
    ...
    void setUpBase() {
        ...
        typesRepo = victor.createRepository(TypesRepository.class);
        personRepo = victor.createRepository(PersonRepository.class);
        passportRepo = victor.createRepository(PassportRepository.class);
    }
