...
class DynamicQueryTest {
    ...
    void testFindByUsername() {
        ...
        VictorLogger.info("✓ Found: " + result.get());
    }
    ...
    void testFindByUsernameOrEmail() {
        ...
        VictorLogger.info("✓ Found " + results.size() + " users:");
        results.forEach(u -> VictorLogger.info("  - " + u.username()));
    }
    ...
    void testFindByAgeGreaterThan() {
        ...
        VictorLogger.info("✓ Found " + results.size() + " users with age > 25:");
        results.forEach(u -> VictorLogger.info("  - " + u.username() + " (age: " + u.age() + ")"));
    }
    ...
    void testFindByNameLike() {
        ...
        VictorLogger.info("✓ Found " + results.size() + " users with 'John' in name:");
        results.forEach(u -> VictorLogger.info("  - " + u.name()));
    }
    ...
    void testFindByEmailIsNull() {
        ...
        VictorLogger.info("✓ Found " + results.size() + " users with null email:");
        results.forEach(u -> VictorLogger.info("  - " + u.username()));
    }
    ...
    void testFindByEmailIsNotNull() {
        ...
        VictorLogger.info("✓ Found " + results.size() + " users with email:");
        results.forEach(u -> VictorLogger.info("  - " + u.username() + " (" + u.email() + ")"));
    }
    ...
    void testFindByActiveOrderByUsernameAsc() {
        ...
        VictorLogger.info("✓ Found " + results.size() + " active users (sorted by username ASC):");
        results.forEach(u -> VictorLogger.info("  - " + u.username()));
    }
    ...
    void testFindByActiveOrderByUsernameDesc() {
        ...
        VictorLogger.info("✓ Found " + results.size() + " active users (sorted by username DESC):");
        results.forEach(u -> VictorLogger.info("  - " + u.username()));
    }
    ...
    void testComplexQuery() {
        ...
        VictorLogger.info("✓ Found " + results.size() + " active users with age > 25 (sorted by name):");
        results.forEach(u -> VictorLogger.info("  - " + u.name() + " (age: " + u.age() + ")"));
    }
